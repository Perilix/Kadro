...
import type { Athlete, AthleteOverview } from '@kadro/shared';
...
export default function CoachAthleteScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: t.bg }}>
      ...
      <View style={{ position: 'absolute', left: 0, right: 0, bottom: 0, flexDirection: 'row', gap: 10, padding: 16, paddingBottom: insets.bottom + 12 }}>
        <View style={{ flex: 1 }}>
          <Button label="Message" ghost onPress={() => router.push('/(coach)/messages')} />
        </View>
      </View>
    </View>
  );
